"""
Reference code: https://github.com/Tony-Y/pytorch_warmup/blob/master/pytorch_warmup/base.py
I need this hack to make this work in two different python evns
"""
