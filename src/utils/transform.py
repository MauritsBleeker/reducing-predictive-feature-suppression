...
https://github.com/naver-ai/pcme/blob/main/datasets/_transforms.py
"""
import math
import torch
...
def imagenet_transform(resize_size=256, crop_size=224, random_resize_crop=False, random_erasing_prob=0.0, custom_transforms=None):
    """

    :param resize_size:
    :param crop_size:
    :param random_resize_crop:
    :param random_erasing_prob:
    ...
    if random_resize_crop:
        logging.info('Adding random resize crop')
    ...
    if random_erasing_prob > 0:
        logging.info('Adding cutout with prob {}'.format(random_erasing_prob))
